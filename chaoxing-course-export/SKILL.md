...
- Do not bypass access controls. If a page or API does not expose answers, record `未公布`.
...
- Include source labels for answers:
  - `学习通`: answer was visible in Chaoxing/Xuexitong.
  - `未公布`: no answer was exposed.
