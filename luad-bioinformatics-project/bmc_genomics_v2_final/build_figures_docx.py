...
("Figure6_singlecell","Figure 6. Single-cell (GSE131907): patient-level enrichment of the signature in malignant/tumour-derived epithelium.",
 "(a) Programme-gene expression across annotated cell types (dot size = percent expressing, colour = mean expression). (b) Malignant (tumour-origin) versus normal epithelial differential expression; 7 of 9 genes are enriched at the patient level (paired Wilcoxon across 10 patients with matched normal and tumour epithelium, FDR<0.05). (c) Programme score peaks in malignant and tumour-transitional epithelial states versus normal epithelium. (d) Programme and PLK1 correlate with proliferation (MKI67) across epithelial cells."),
